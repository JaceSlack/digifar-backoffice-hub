...
const InternalReports: React.FC = () => {
  const reports = [
    ...
    },
    {
      ...
      description: 'Revenue, profit margins, and financial trend analysis',
    ...
    },
    {
      ...
      description: 'System performance, processing times, and efficiency metrics',
      lastGenerated: '2024-01-14 23:30 PM',
      format: 'PDF',
      frequency: 'Weekly',
      size: '3.2 MB'
    },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200 p-6 text-center">
          ...
          <div className="text-2xl font-bold text-gray-900">156MB</div>
